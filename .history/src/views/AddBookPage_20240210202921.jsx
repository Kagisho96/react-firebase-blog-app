        ...
        <div className="container">
            ...
            <p className="text-xl uppercase mt-6 mb-5 font-semibold text-center">
              Add new Blog
                ...
                <div className="w-full border rounded-md border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium outline-none focus:shadow-md focus:border-[#6a64f1] text-[#6B7280]">
                    <label>Title *</label>
