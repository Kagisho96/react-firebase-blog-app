...
//           <p className="md:flex font-bold text-lg hidden">
//             Welcome to <span className="text-orange-400 text-2xl mx-2">Blog Post</span> Application
//           </p>
...
//               <div className="text-white hover:text-orange-400">
//                 <NavLink to="/add-book" >
//                   <button className="bg-orange-400 hover:bg-gray-200 py-2 px-4 text-gray-100 hover:text-gray-900 rounded-md font-medium transition-all duration-200 ease-in">Add Book +</button>
//                 </NavLink>
//               </div>
//               <div className="">
//               <button
    ...
    <>
      ...
      <header className="bg-black text-white fixed left-0 right-0 top-0 z-50">
        <nav className="px-4 py-4 max-w-7xl mx-auto flex justify-between items-center">
          ...
          <p className="md:flex font-bold text-lg hidden">
            Welcome to <span className="text-orange-400 text-2xl mx-2 animate-bounce">Blog Post</span> Application
          </p>
