    ...
    <header className="bg-black text-white fixed left-0 right-0 top-0">
      <nav className="px-4 py-4 max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="text-white lg:flex gap-6 items-center mr-8 hidden">
          ...
          <button onClick={} className="bg-orange-400 hover:bg-gray-200 py-2 px-4 text-gray-100 hover:text-gray-900 rounded-md font-medium transition-all duration-200 ease-in">
            Log In
          </button>
        </div>
