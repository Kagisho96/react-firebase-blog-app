...
function Book({book}) {
    ...
    return (
        <>  
            ...
            <Link to={'/book/' + book.id}  className="p-5 cursor-pointer rounded-md shadow-lg"
           >
            <div className="">
                <img src={book.cover} className="w-full" alt="" />
                
            </div>
            <h3 className="mt-4 mb-2 font-bold cursor-pointer hover:text-blue-700">{book.title}</h3>
            <p className="mb-2 text-gray-600"> <FaUser className="mr-2 inline-flex items-center"/>{book.author}</p>
